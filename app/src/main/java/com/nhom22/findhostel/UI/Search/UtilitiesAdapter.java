    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch (items.get(i).getUtilities().getName()) {
            case "Điện":
                ...
                tvQuantity.setText(String.valueOf(items.get(i).getUtilities().getName()) + "\n(" +
                        String.valueOf(items.get(i).getPrice()) + "/" + items.get(i).getUnit() + ")");
                break;
            case "Nước":
                imgIcon.setImageResource(R.drawable.water);
                tvQuantity.setText(String.valueOf(items.get(i).getUtilities().getName()) + "\n(" +
                        String.valueOf(items.get(i).getPrice()) + "/" + items.get(i).getUnit() + ")");
                break;
            case "Giữ xe":
